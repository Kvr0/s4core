...
# Mobへ代入
    ...
    # Common
        execute if score $SubtractedHealth ScoreDamageCore matches ..0 if entity @s[type=player] run effect give @s instant_damage 1 124 true
        execute if score $SubtractedHealth ScoreDamageCore matches ..0 if entity @s[type=!player] run kill @s
# 演出
